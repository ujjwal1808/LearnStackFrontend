...
const NavBarInstructor = ({ profileImage }) => {
    ...
    const handleLogout = () => {
        ...
        // Redirect and replace current history
                ...
                <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Link to="/instructor/profile">
                            ...
                            <button className=" bg-indigo-600 text-white px-5 py-2 rounded-lg" onClick={handleLogout}>Log Out</button>
